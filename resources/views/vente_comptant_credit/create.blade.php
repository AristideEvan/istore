                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('venteComptantCredits.store') }}" id="">
                            ...
                            <fieldset>
                                ...
                                <div class="row" id="">
                                    <div class="col-md-3">
                                        <label for="typeArticle">{{ __('Type article')}} <span style="color: red">*</span></label>
                                            <select name="typeArticle" class="form-control" id="typeArticle" required>
                                                <option value="">-- Sélectionner --</option>
                                    ...
                                    <div class="col-md-2">
                                        <label for="article_id">{{ __('Article')}} <span style="color: red">*</span></label>
                                    ...
                                    <div class="col-md-2">
                                        <label for="qteRestant">{{ __('Qte restante')}}</label>
                            ...
                            {{-- Bloc Infos Montants --}}
                           <fieldset>
                            <legend>Informations montant</legend>
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                            <div class="row">
                                                ...
                                                <input type="number" step="0.01" id="mtTotalVente" name="mtTotalVente" class="form-control">
                                                <div class="invalid-feedback">
                                                    {{__('formulaire.Obligation')}}
                                                </div>
                                                @error('mtTotalVente')
                                            ...
                                            <div class="row">
                                                ...
                                                <select name="remise_id" class="form-control" id="remise_id" step="0.01" required>
                                                    <option value="">-- Sélectionner --</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="number" step="0.01" id="mtRemiseVente" name="mtRemiseVente" class="form-control">
                                                <div class="invalid-feedback">
                                                    {{__('formulaire.Obligation')}}
                                                </div>
                                                @error('mtRemiseVente')
                                            ...
                                            <div class="row">
                                                ...
                                                <select name="taxe_id" class="form-control" id="taxe_id" step="0.01" required >
                                                    <option value="#">-- Sélectionner --</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="number" step="0.01" id="mtTvaVente" name="mtTvaVente" class="form-control">
                                                <div class="invalid-feedback">
                                                    {{__('formulaire.Obligation')}}
                                                </div>
                                                @error('mtTvaVente')
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="number" step="0.01" id="mtNetVente" name="mtNetVente" class="form-control">
                                                <div class="invalid-feedback">
                                                    {{__('formulaire.Obligation')}}
                                                </div>
                                                @error('mtNetVente')
