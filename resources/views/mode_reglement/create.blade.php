        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-0">{{ __('Ajouter mode règlement') }}</div>
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('modeReglements.store') }}">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ old('libelleModeReglement') }}" required autofocus onkeyup="this.value = this.value.toUpperCase()" placeholder="Mode règlement";>
