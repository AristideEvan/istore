                                        ...
                                        <div class="col-md-6">
                                            <select id="parent" class="form-control @error('parent') is-invalid @enderror" name="parent"
                                                ...
                                                @foreach ($datas as $parent)
                                                    <option value="{{ $parent->menu_id }}">{{ $parent->nomMenu }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select id="action" class="form-colienntrol @error('action') is-invalid @enderror" name="action[]"
                                             autocomplete="action" multiple autofocus>
                                                <option value=""></option>
                                                @foreach ($actions as $action)
                                                    <option value="{{ $action->action_id }}">{{ $action->nomAction }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                {{__('formulaire.Obligation')}}
