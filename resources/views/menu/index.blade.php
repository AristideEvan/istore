                    ...
                    <tbody>
                        @foreach($listeMenus as $item)
                            <tr>
                                ...
                                <td><input type="checkbox" name="visible{{$item->id}}" id="/setVisibleMenu/{{$item->id}}" value="{{$item->menu_id}}"
                                        @if($item->visible) checked @endif
                                    
                                     onclick="setVisible(this.id)">
                                </td>
                                @php $route = 'route'; echo $controler->crudbody($rub,$srub,$route,'menu.edit','menu.destroy',$item->menu_id); @endphp
                            </tr>
                        @endforeach
                    </tbody>
                </table>
