                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (Array.isArray(data)){
                            ...
                            console.log(client);    
                            var txtNomPrenoms = client.nomClient +' '+ client.prenomClient + ' ' + client.telephoneClient;
                            $('#client_id').append('<option value="'+ client.client_id +'">'+ txtNomPrenoms +'</option>');
                         }
                        }
                    },
                });
                ...
                $.ajax({
                    ...
                    if (Array.isArray(data)){
                        ...
                        for(const article of data){
                            $('#stockBody').append('<tr>'+
                                                        '<td>'+ article.libelleTypeArticle +'</td>'+
                                                        '<td>'+ article.libelleArticle +'</td>'+
                                                        '<td>'+ article.qteRestant +'</td>'+
                                                    '</tr>');
                        }
                        $('#example').DataTable();  
                    }              
